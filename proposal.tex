...
\usepackage{hypernat}
\usepackage{times,epsf,epsfig,psfig,pdfpages,subfigure,amsmath,amssymb,wrapfig}
...
%{\large  Salman Avestimehr, USC}

%\vspace{0.05in}
%
%{\large \bfseries University of Southern California (USC) }
...
\begin{itemize}
\item Label: ``Proposal: Volume 1''
\item BAA number: ??
\item Technical area: TA1
\item Proposal title: ??
\item Lead organization (prime contractor) name: University of Illinois at Urbana Champaign (UIUC)
\item Type of organization: Other Educational
\item Technical point of contact (POC): Prof. Nam Sung Kim, Tel: (217) 244-9169, email: \url{nskim@illinois.edu}, Address: ??.
\item Administrative POC: FILL UIUC INFO Janet Ng, Contract and Grant Officer, Tel: (213) 740-6478, email: \url{janetng@research.usc.edu}, Address: University of Southern California, 3720 South Flower Street, 3rd Floor, Los Angeles, CA.
\item Award instrument requested: FILL cooperative agreement
\item Total amount of the proposed effort: The project has three phases, costing \$3,739,215 and a 1-year option phase, costing \$478,539 (total cost of \$4,217,754).
\item Place(s) and period(s) of performance: University of Southern California, Los Angeles, CA. Phase 1 \& 2: 4 years (3/1/2017 ? 2/28/2021); Option Period: 1 year (3/1/2019 ? 2/28/2020).
\item Other team member information: \begin{itemize}
\item Prof. Murali Annavaram, Tel: (213) 740-3299 , email: \url{annavara@usc.edu}, Address: EEB 232, University of Southern California, Los Angeles, CA.
\item FILL.
\end{itemize}
\item Proposal validity period: 180 days
\item Data Universal Numbering System (DUNS) number: FILL
\item Taxpayer identification number: FILL
\item Commercial and Government Entity (CAGE) code: FILL
\item Security POC including name, mailing address, telephone number, and email
address, if applicable: NA
\item Proposer's reference number (if any): NA
\end{itemize}
...
\input{B-technical.tex}

\section{Statement of Work}
\input{C-SOW.tex}

\section{Deliverables}
\input{D-deliverable.tex}
...
\input{G-accomplishment.tex}

\section{Facilities}
\input{H-facility.tex}

\section{Schedule and Milestone}
\input{I-milestone.tex}
