...
\noindent
1.1 The functional and architectural simulators that model the GAMA accelerator module (Tasks 1--4, and 7).
...
\noindent
2.5 The technical documents describing 2.1 -- 2.4 with developed software code and performance analyses in detail.
